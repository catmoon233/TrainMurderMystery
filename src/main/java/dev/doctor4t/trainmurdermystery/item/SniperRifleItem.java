...
public class SniperRifleItem extends Item {
    ...
    public void appendHoverText(@NotNull ItemStack stack, @NotNull TooltipContext context,
        ...
        tooltip.add(Component.translatable("item.trainmurdermystery.sniper_rifle.scope",
                hasScope ? Component.translatable("item.trainmurdermystery.sniper_rifle.scope.installed")
                        : Component.translatable("item.trainmurdermystery.sniper_rifle.scope.not_installed")));
