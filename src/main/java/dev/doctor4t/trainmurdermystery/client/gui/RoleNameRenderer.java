            ...
            if (component.isRunning()) {
                ...
                if (targetRole2 !=null){
                    if (!targetRole2.isInnocent() && playerRole.equals(TrainRole.KILLER)) {
                        if (!targetRole2.getIdentifier().getNamespace().equals("stupid_express") && !targetRole2.getIdentifier().getPath().equals("recorder") && !targetRole2.getIdentifier().getPath().equals("gambler")) {
