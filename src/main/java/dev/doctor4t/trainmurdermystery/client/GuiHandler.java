...
//
//    public static final Identifier SANITY_INDICATOR = new Identifier(SanityMod.MODID, "textures/sanity_indicator.png");
//    public static final Identifier BLOOD_TENDRILS_OVERLAY = new Identifier(SanityMod.MODID, "textures/overlay/blood_tendrils.png");
//    public static final MutableText[] HINTS0;
//    public static final MutableText[] HINTS1;
//
//    private final MinecraftClient m_mc;
...
//
//    private MutableText m_hint;
//
//    public GuiHandler()
//    {
//        m_mc = MinecraftClient.getInstance();
//    }
//
//    static
//    {
//        HINTS0 = new MutableText[12];
//        for (int i = 0; i < HINTS0.length; i++)
//        {
//            HINTS0[i] = Text.translatable("gui." + TMM.MOD_ID + ".hint0" + i);
//        }
//        HINTS1 = new MutableText[9];
//        for (int i = 0; i < HINTS1.length; i++)
//        {
//            HINTS1[i] = Text.translatable("gui." + TMM.MOD_ID + ".hint1" + i);
//        }
//
//    }
//
