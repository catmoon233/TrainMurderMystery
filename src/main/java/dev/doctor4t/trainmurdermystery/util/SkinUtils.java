...
public class SkinUtils {
    ...
    public static String getItemSkin(ItemStack itemStack) {
        if (itemStack.getItem() instanceof dev.doctor4t.trainmurdermystery.item.ItemWithSkin) {
    ...
    public static boolean isItemSkinnable(ItemStack itemStack) {
        return itemStack.getItem() instanceof dev.doctor4t.trainmurdermystery.item.ItemWithSkin;
    }
    ...
    public static String getSkinConfigId(ItemStack itemStack) {
        return TMM.MOD_ID + ":" + getItemSkin(itemStack);
    }
